...
save_classification_report_as_image(classification_report(y_test, y_pred, output_dict=True), "crop_classification_report.png")
...
save_confusion_matrix_as_image(cm, label_encoders["Crop Type"].classes_, "crop_confusion_matrix.png")
...
save_feature_importance_as_image(importances, feature_names, "crop_feature_importance.png")